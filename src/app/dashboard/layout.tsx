            ...
            <div className="flex flex-col h-screen bg-gray-50">
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    <main className="flex-1 overflow-y-auto p-4">
                        {activeTab === 'courses' && !selectedCourseId && <DashboardContent isSidebarOpen={isSidebarOpen} />}
                        {activeTab === 'explore' && !selectedCourseId && <ExploreCoursesContent />}
                        {activeTab === 'internship' && !selectedCourseId && <InternshipContent isSidebarOpen={isSidebarOpen} />}
                        {activeTab === 'settings' && !selectedCourseId && <SettingsContent />}
                        {selectedCourseId && <CoursePurchasePage courseId={selectedCourseId} />}
                    </main>
                </div>
            </div>
        </SearchProvider>
